...
\newcommand{\WL}[1]{\textsf{Log}^{#1}}
\newcommand{\WLat}[2]{\textsf{Log}^{#1}\left(#2\right)}
\newcommand{\W}{\textbf{\textsf{Messages}}}
\newcommand{\Unseen}[1]{\textsf{Unseen}_{#1}}
\newcommand{\EstUnseen}[2]{\textsf{EstUnseen}_{#1}{\left(#2\right)}}
...
\newcommand{\vtphys}[1]{\mathrm{vt}^{#1}}
\newcommand{\timestamp}[1]{\mathsf{time}\left(#1\right)}
\newcommand{\Uncommitted}[1]{\textsf{Log}_{\textrm{uncom}}^{#1}}
...
\newcommand{\View}[2]{\textsf{View}^{#1}\left(#2\right)}
