...
\begin{example}
  ...
  \begin{itemize}
    \tightlist
  \item Figure~\ref{fig:ordex-non-fifo} violates FIFO because messages $m_1$
...
whether in the form of summary and acknowledgement vectors (Sections
...
seen, and tenative writes applied in an order differing from the final
global order. Numerical error and real-time error (used interchangably
