...
% In the case of \emph{Byzantine faults}\citationneeded, the network
% might even act like a malicious adversary.
...
%This happens when message lines intersect, or when they \emph{would}
%intersect if extended indefinitely. (NOTE: THIS IS TOTALLY FALSE.)
...
\begin{figure}[p]
  ...
  \begin{subfigure}{1\textwidth}
    \centering
    \input{images/pgf/external1.pgf}
    \caption{Time diagram for memory operations}
    \label{fig:external1}
  \end{subfigure}

  \begin{subfigure}{1\textwidth}
    \centering \input{images/pgf/externalDAG.pgf}
