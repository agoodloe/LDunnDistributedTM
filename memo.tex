...
denoted $H_P$, is the sequence of accesses $P$ has applied to $\Dinit$
...
in the system:
\begin{equation}
  \Hglobal \equiv \bigcup_{X \in \AllProc} H_X
\end{equation}
...
there are $|\mathcal{P}| - 1$ processes that can accept writes without
