...
safety of people in a general systems context. In the context of emergency response, most safety properties probably affect human safety in some way, but not all properties that affect human safety are ``safety'' properties in the sense meant here. Instead, a \emph{safety} property is defined as a prohibition that stops
...
ground personnel. Throughout the remainder of this document, ``safety'' will always refer to the narrow meaning of the word, unless it is clear from context that the everyday definition is meant.
