...
\begin{definition}[Order error]
  ...
  set for $\mathcal{F}$.
  \begin{equation}
    \OrderError\left(a, \mathcal{F}\right) \equiv \sum_{F \in \Conits} \{ \OrderWeight\left(w, F\right) \mid w \in \mathsf{OOO}\left(a, \Conits\right) \}
  \end{equation}
\end{definition}
...
following value:
\begin{equation}
  \EstOrderError\left(a, \mathcal{F}\right) \equiv \sum_{F \in \Conits} \{ \OrderWeight\left(w, F\right) \mid w \in \Uncommitted{P}|_\Conits \}
\end{equation}
Now
