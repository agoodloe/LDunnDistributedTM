...
prohibitive for the networks under consideration. We concluded that
weaker consistency models are called for in these settings.
...
seems to suggest the application designer is left stuck between a rock
and a hard place.
