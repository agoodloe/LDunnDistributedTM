...
\SupplementaryNotes{}
\Acknowledgment{The first author conducted the work during a summer internship at the NASA Langley Research Center in the Safety-Critical Avionics Systems Branch focusing on distributed computing  issues arising in the Safety Demonstrator challenge in the NASA Aeronautics System Wide Safety (SWS) program.}
...
is frequently cited as a national priority \cite{pcast2023}.
First responders often stress the need for new technology
to improve communications and data sharing.  
  Second, the rules for
...
microcosm for the general challenges faced by other,
non-emergency applications.


  The systems we examine must function under harsh operating conditions that limit their
...
system should in some sense be a \emph{continuous} function~\footnote{For a mathematical introduction to the topological notion of continuity see \cite{mendelson2012introduction}.}   of its
...
communications hardware and physical infrastructure. It is also
a computer science and software problem concerned with the
...
global system.  While the CAP theorem is often presented as an 
...
failures often coincide with the conditions that demand
...
consecutive integers. If message $1$ arrives and then message $3$ arrives, $Q$
infers that message $2$ is lagging behind, delivering message $1$ to the user, but
withholding delivery of message $3$ until after message $2$ is received and delivered.
